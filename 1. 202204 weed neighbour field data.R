...
floristic.edge.ac<-subset(floristic.edge,floristic.edge$type=="conventional")
aggregate(floristic.edge.ac,list(floristic.edge.ac$field),FUN=mean)

floristic.crop.ac<-subset(floristic.crop,floristic.crop$type=="conventional")
test<-aggregate(floristic.crop.ac,list(floristic.crop.ac$field),FUN=mean)
...
floristic.crop.c<-subset(floristic.crop.c,field %in% c("5","14","16","6","19","21","8","15","11","7","17","13","2","18","4","10"))

floristic.crop.o<-subset(floristic.crop,floristic.crop$type=="organic ")
floristic.crop.o<-subset(floristic.crop.o,field %in% c("1","22","10","17","15","11","2","21","3","8","5","4","12","13"))
